...
**[React to do list  ]** is a to do list app built with React 
...
Clone this repository to your desired folder:
 https://github.com/josuerushanika/React-with-toda/tree/setup

 Example commands:

```sh
  cd my-folder
  git clone https://github.com/josuerushanika/React-with-toda.git
```
